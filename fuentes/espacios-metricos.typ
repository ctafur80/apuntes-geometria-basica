...
$ g(0) = sigma 0 + tau = tau = h(0) $

Por otro lado, se debe dar que $g(1) = h(1)$. Veámoslo:

$ g(1) = sigma + tau = sigma + h(0) = h(1) $

Por tanto, $sigma = h(1) - h(0)$. Estos dos resultados producen la fórmula
que hemos dado para $g(x)$.
...
Partiendo de la hipótesis, supongamos ahora otra isometría $g = f_1^(-1)
compose f_2$, pues, tal y como se explicó, la composición de dos isometrías
sobre un mismo espacio métrico es también una isometría sobre ese mismo
espacio métrico, por lo que $g in "Isom"(bb(R), d_(bb(R)))$.

Por la hipótesis anterior, tenemos que
