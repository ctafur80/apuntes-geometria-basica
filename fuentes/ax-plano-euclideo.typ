...
muestra en el Axioma $bold(P)$3 (de la Regla Graduada).
...
Una vez vista la Observación 2.3 y el Axioma $bold(P)2$, me gustaría aclarar
las relaciones que se dan entre pares (no ordenados) de puntos y los
segmentos y las rectas.
...
#theorem[Ampliación del Punto (3) del Axioma $bold(P)$4][
...
#theorem[de Conservaciones de Figuras por Isometrías][
...
#theorem[de la Conservación del Punto Medio de un Segmento por Isometría][
...
Alternativamente, se podría haber usado el Axioma $bold(P)$3 para esta
demostración.
...
#theorem[de la Isometría de Dos Rectas Secantes][
...
#theorem[de las Isometrías de Semirrectas][
